...
public final class PingPongServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.bineeta.grpc.server.PingRequest,
      com.bineeta.grpc.server.PongResponse> METHOD_PING =
      io.grpc.MethodDescriptor.<com.bineeta.grpc.server.PingRequest, com.bineeta.grpc.server.PongResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "PingPongService", "ping"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.bineeta.grpc.server.PingRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.bineeta.grpc.server.PongResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class PingPongServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void ping(com.bineeta.grpc.server.PingRequest request,
        io.grpc.stub.StreamObserver<com.bineeta.grpc.server.PongResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.bineeta.grpc.server.PingRequest,
                com.bineeta.grpc.server.PongResponse>(
                  this, METHODID_PING)))
          .build();
    }
  }
  ...
  public static final class PingPongServiceBlockingStub extends io.grpc.stub.AbstractStub<PingPongServiceBlockingStub> {
    ...
    /**
     */
    public com.bineeta.grpc.server.PongResponse ping(com.bineeta.grpc.server.PingRequest request) {
  ...
  public static final class PingPongServiceFutureStub extends io.grpc.stub.AbstractStub<PingPongServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bineeta.grpc.server.PongResponse> ping(
        com.bineeta.grpc.server.PingRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_PING:
          serviceImpl.ping((com.bineeta.grpc.server.PingRequest) request,
              (io.grpc.stub.StreamObserver<com.bineeta.grpc.server.PongResponse>) responseObserver);
          break;
        default:
  ...
  private static final class PingPongServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.bineeta.grpc.server.PingPongServiceOuterClass.getDescriptor();
    }
  }
