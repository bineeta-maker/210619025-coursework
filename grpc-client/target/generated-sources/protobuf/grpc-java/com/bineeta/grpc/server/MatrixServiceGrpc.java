...
public final class MatrixServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.bineeta.grpc.server.MatrixRequest,
      com.bineeta.grpc.server.MatrixReply> METHOD_MULTIPLY_BLOCK =
      io.grpc.MethodDescriptor.<com.bineeta.grpc.server.MatrixRequest, com.bineeta.grpc.server.MatrixReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "matrixmult.MatrixService", "MultiplyBlock"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.bineeta.grpc.server.MatrixRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.bineeta.grpc.server.MatrixReply.getDefaultInstance()))
          .build();
  @io.grpc.ExperimentalApi("https://github.com/grpc/grpc-java/issues/1901")
  public static final io.grpc.MethodDescriptor<com.bineeta.grpc.server.MatrixRequest,
      com.bineeta.grpc.server.MatrixReply> METHOD_ADD_BLOCK =
      io.grpc.MethodDescriptor.<com.bineeta.grpc.server.MatrixRequest, com.bineeta.grpc.server.MatrixReply>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
  ...
  public static abstract class MatrixServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void multiplyBlock(com.bineeta.grpc.server.MatrixRequest request,
        io.grpc.stub.StreamObserver<com.bineeta.grpc.server.MatrixReply> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_MULTIPLY_BLOCK, responseObserver);
    }

    /**
     */
    public void addBlock(com.bineeta.grpc.server.MatrixRequest request,
        io.grpc.stub.StreamObserver<com.bineeta.grpc.server.MatrixReply> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.bineeta.grpc.server.MatrixRequest,
                com.bineeta.grpc.server.MatrixReply>(
  ...
  public static final class MatrixServiceBlockingStub extends io.grpc.stub.AbstractStub<MatrixServiceBlockingStub> {
    ...
    /**
     */
    public com.bineeta.grpc.server.MatrixReply multiplyBlock(com.bineeta.grpc.server.MatrixRequest request) {
    ...
    /**
     */
    public com.bineeta.grpc.server.MatrixReply addBlock(com.bineeta.grpc.server.MatrixRequest request) {
      return blockingUnaryCall(
  ...
  public static final class MatrixServiceFutureStub extends io.grpc.stub.AbstractStub<MatrixServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bineeta.grpc.server.MatrixReply> multiplyBlock(
        com.bineeta.grpc.server.MatrixRequest request) {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.bineeta.grpc.server.MatrixReply> addBlock(
        com.bineeta.grpc.server.MatrixRequest request) {
      return futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_MULTIPLY_BLOCK:
          serviceImpl.multiplyBlock((com.bineeta.grpc.server.MatrixRequest) request,
              (io.grpc.stub.StreamObserver<com.bineeta.grpc.server.MatrixReply>) responseObserver);
          break;
        case METHODID_ADD_BLOCK:
          serviceImpl.addBlock((com.bineeta.grpc.server.MatrixRequest) request,
              (io.grpc.stub.StreamObserver<com.bineeta.grpc.server.MatrixReply>) responseObserver);
          break;
        default:
  ...
  private static final class MatrixServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.bineeta.grpc.server.MatrixMult.getDescriptor();
    }
  }
